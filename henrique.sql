...
(3, 'Jeovana Miranda', 20, '2013-07-15', 'Rua do IF s/n', 'AP'),
(4, 'eduardo', 45, NULL, NULL, NULL),
(5, 'nicole', 56, NULL, NULL, NULL),
(6, 'FABIOOO', 67, NULL, NULL, NULL),
(7, 'alan', 67, NULL, NULL, NULL);
...
CREATE TABLE Nota(
    ...
    nota_1 int(3),
    nota_2 int(3),
    FOREIGN KEY (iddis) REFERENCES disciplina(id) ON DELETE CASCADE,
	FOREIGN KEY (idaluno) REFERENCES aluno(id) ON DELETE CASCADE
);

INSERT INTO `Nota` (`idnota`, `idaluno`, `iddis`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 2, 3);